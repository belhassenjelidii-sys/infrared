...
const labels:Record<string,string>={NEW:"Nouvelle",CONFIRMED:"Confirmée",PREPARING:"En préparation",SHIPPED:"Expédiée",READY:"Expédiée",DELIVERED:"Livrée",CANCELLED:"Annulée"};
